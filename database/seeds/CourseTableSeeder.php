...
class CourseTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        factory(Course::class, 50)->make()->each(function($course, $index) use($faker, $hospitals, $minors, $options, $tax_classes, $calendars) {
            ...
            $course_option->fill([
               'course_id' => $course->id,
                'option_id' => $faker->randomElement($options)->id
            ]);
            $course_option->save();

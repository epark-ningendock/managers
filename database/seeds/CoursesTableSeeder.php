...
class CoursesTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $hospitals->each(function($hospital) use ($faker, $hospitals, $minors, $options, $tax_classes, $calendars, $hospital_images, $image_orders){
            factory(Course::class, 20)->make()->each(function ($course, $index) use ($hospital, $faker, $hospitals, $minors, $options, $tax_classes, $calendars, $hospital_images, $image_orders) {

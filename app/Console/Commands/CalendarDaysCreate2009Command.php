...
class CalendarDaysCreate2009Command extends Command
{
	protected $signature = 'calendar-day-create-2009
                            {--addmonth= : 追加月数}';
	...
	public function handle()
	{
		...
		$base_date = Carbon::parse('2020-09-20 00:00:00')->addMonths($add_month);
		$public_holidays = collect(Yasumi::create('Japan', $base_date->year, 'ja_JP')->getHolidays())->flatten(1);
		// 対象データ取得
		$from_date = Carbon::parse('2020-09-20 00:00:00')->addMonths($add_month)->startOfMonth();
		...
		foreach ($calendars as $calendar) {
			$this->info('カレンダー処理');
			$date = Carbon::parse('2020-09-20 00:00:00')->addMonths($add_month)->startOfMonth();
			$end_date = Carbon::parse('2020-09-20 00:00:00')->addMonths($add_month + 1)->startOfMonth();

    ...
    public function rules()
    {
        if (str_contains($this->url(), 'course/sort/update')) {
            ...
            return [
                ...
                'reception_start_day' => 'required|integer|min:1',
                'reception_start_month' => 'required|integer|min:1',
                'reception_end_day' => 'required|integer|min:1',
                'reception_end_month' => 'required|integer|min:1',
                'reception_acceptance_day' => 'required|integer|min:1',
                'reception_acceptance_month' => 'required|integer|min:1',
                'cancellation_deadline' => 'required|integer|min:1',
